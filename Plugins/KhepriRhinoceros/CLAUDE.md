...
- **Rendering**: `Render`, `SaveView`, `SetView`, `View`, `ViewCamera`, `ViewTarget`, `RenderLoadHEnvironment`, `SunLight`, `PointLight`
- **Layers**: `CreateLayer`, `CurrentLayer`, `SetCurrentLayer`, `SetLayerActive`, `DeleteAllInLayer`
