...
namespace KhepriUnity {
    public class Channel : KhepriBase.Channel, IDisposable {
        ...
        public GameObject rGameObject() => shapes[rInt32()];
        ...
        public Material rMaterial() {
            int value = rInt32();
            return value < 0 ?
                Primitives.Instance.DefaultMaterial :
                materials[value];
        }
        ...
        protected override void Dispose(bool disposing) {
            ...
            if (disposing) {
                try {
                    ...
                    Debug.LogError($"Error during Channel disposal: {ex.Message}");
                }
            }
