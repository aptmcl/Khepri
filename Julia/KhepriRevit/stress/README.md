...
## Moradia T4 status (2026-07-18)

`moradia` reports **VERDICT: PASS** across every metric, including the full group set
(11 types / 12 instances exact via deferred finalize_groups + PlaceGroup type sharing).
The NewGroup crash documented earlier was CAUSED by z-inconsistent member elevations;
